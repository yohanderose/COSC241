...
public class Tableau {
    ...
    public void addValue(Integer value) {
        if (smallest == null) {
            ...
            Cell pointer = smallest;
            Integer x = addToRow(pointer, value);

            while (x != null) {

                if (pointer.below != null) {
                    pointer = pointer.below;  //explicitly change the pointer,
                                                //unlike recursion
                    x = addToRow(pointer, x);
                } else {
                    pointer.below = new Cell(x);
                    pointer.below.above = pointer;
                    break;
                }
            }
